    ...
    <div className="w-full max-w-3xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      >
        ...
        <textarea
          ...
          rows={6}
          className="w-full rounded-xl bg-slate-950 border border-slate-800 px-4 py-3 text-base sm:text-sm text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-green-400"
        ...
        <div className="flex justify-between items-center pt-2">
          ...
          <button
            type="submit"
            disabled={!text.trim()}
            className="px-5 py-3 rounded-lg text-sm font-semibold bg-green-500 text-white hover:bg-green-400 active:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed transition min-h-[44px] touch-manipulation"
          >
            Submit feedback
          </button>
        </div>
